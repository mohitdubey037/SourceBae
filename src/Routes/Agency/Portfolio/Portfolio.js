            ...
            <div className="work_parent">
              <div>
                ...
                <div className="work_desc">
                  <p>
                    Provide Some Details of successful projects you have worked
                    on
                  </p>
                </div>
              </div>
              <div>
                ...
                <div className="work_desc">
                  <p>
                    Ask for a quick, 2-min review from your clients or upload a
                    proof
                  </p>
                </div>
              </div>
              <div>
                ...
                <div className="work_desc">
                  <p>
                    These projects and reviews are showcased for better
                    conversion
                  </p>
                </div>
              </div>
            ...
            <section className="portfolio_section">
              ...
              <div className="logo_parent_div">
                <div className="portfolio_inputs">
                  ...
                  <div>
                    <p className="project-question">
                      Do You have a website(product) link ?
                    </p>
                    <input
                      name="projectLink"
                      type="text"
                ...
                <div className="portfolio_inputs portfolio_inputs_second">
                  ...
                  <div>
                    <p className="project-question">
                      What was the project timeline ?(in days){" "}
                    </p>
                    <input
