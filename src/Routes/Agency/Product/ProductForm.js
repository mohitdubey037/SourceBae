                    ...
                    <div className="productForm_parent">
                        ...
                        <div className="productsHeadlines">
                            <div className="innerProductHeadlines">
                                <h3>
                                    <span> Clients </span> want to know your
                                    product..!!
                                </h3>
                                <p>
                                    First impressions last, create your first
                                    here.
                                </p>
                            </div>
                        </div>
                                        ...
                                        <section>
                                            ...
                                            >
                                                <Select
                                                    ...
                                                    id="demo-simple-select"
                                                    value={
                                                        apiData.productRevenueGenerated
                                                    }
                                        ...
                                        <section className="previousFunding typeOfFunding">
                                            ...
                                            >
                                                <Select
                                                    ...
                                                    id="demo-simple-select"
                                                    value={
                                                        apiData.productFundingTypeLookingFor
                                                    }
                                        ...
                                        <section>
                                            ...
                                            >
                                                <Select
                                                    ...
                                                    value={
                                                        apiData.productCustomerAccquired
                                                    }
                                                    onChange={(event) =>
                                                        handleChange(event)
                                                    }
                                        ...
                                        <div className="form4_Fields">
                                            <section>
                                                ...
                                                <input
                                                    ...
                                                    value={
                                                        apiData.productCompanyLocation
                                                    }
                                                    onChange={handleChange}
                                                />
