        ...
        <div style={{ display: 'flex', justifyContent: 'flex-start' }}>
            ...
            <main
                style={{
                    ...
                    width:
                        width > 500 ? '100%' : isDrawerOpen ? '80vw' : '100vw',
                    marginLeft:
                        width > 500 ? '20vw' : isDrawerOpen ? '20vw' : 0,
            ...
            >
                ...
                <div className="summary additional__detail">
                    ...
                    <p>
                        ...
                        Sapiente tempore repudiandae repellendus natus molestias
                        maiores nobis iste vitae accusamus consequatur, alias
                        quis dolor consectetur inventore maxime quas optio
                        ducimus quam id magnam eligendi tenetur eius nam hic?
                        Excepturi laborum eum quam maxime minima facere, ipsa
                        vitae corporis omnis architecto perspiciatis?
                    </p>
                </div>
                ...
                <div className="work__experience additional__detail">
                    ...
                    <p>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit.
                        Alias quia ipsum eligendi itaque repudiandae quam fugiat
                        expedita a, natus recusandae harum quod sed. Ipsum a
                        assumenda quidem sapiente, ducimus placeat, earum maxime
                        commodi, laborum asperiores cupiditate sit sunt porro.
                        Eius rerum quod maxime fuga voluptatum dolore odit
                        repellat quas accusantium.
                    </p>
                </div>
            </main>
        </div>
