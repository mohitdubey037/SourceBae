...
const Filtration = () => {
    ...
    const FilterButton = ({ title }) => {
        ...
        const handleFilterClick = (filterId) => {
            ...
            document
                ...
                .classList.toggle('filter__clicked');
        };
    ...
    const HiringDetail = ({ title, icon }) => {
        return (
            <div
                className="hiring__detail"
                style={{ color: colors.LIGHT_GRAY, fontFamily: 'Open Sans' }}
            >
                {icon == 'Remote' ? (
                    <LocationOn />
                ) : icon == 'fullTime' ? (
                ...
                <div className="filter__container">
                    <div className="filters">
                        ...
                        <div className="filtered__list">
                            <div className="numberOf__results">
