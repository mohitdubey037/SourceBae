    ...
    const handleErrorsValidation = (role) => {
        ...
        if (role === AGENCY) {
            if (agencyProfileDetails?.agencyName === '') {
                ...
                err.agencyNameError =
                    'Agency name must be between 2 characters.';
                        ...
                        <div className="form__area">
                            <div className="client__form">
                                ...
                                <div className="client__formsContainer">
                                    <form
                                        className="client__form form__1"
                                        autoComplete="off"
                                    >
                                        <div>
                                                ...
                                                <div>
                                                    <div className="input_with_error">
                                                        ...
                                                        <input
                                                            ...
                                                            value={
                                                                agencyProfileDetails.agencyName
                                                            }
                                                            onChange={(event) =>
                                                                handleCreateProfile(
                                                                    event,
                                            ...
                                            <>
                                                ...
                                                <div className="input_with_error">
                                                    ...
                                                    <input
                                                        ...
                                                        name="companyName"
                                                        value={
                                                            clientProfileDetails.companyName
                                                        }
