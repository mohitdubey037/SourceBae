          ...
          <div className="client__form">
            ...
            >
              <div className="form__title">
                <h6>Register as {roleString}</h6>
              </div>
              <div className="title__subtext">
                <p>
                  For the purpose of industry regulation, your details <br />{" "}
                  are required
                </p>
              </div>
            </div>
            ...
            <div className="client__formsContainer">
              <form className="client__form form__1" autoComplete="off">
                ...
                <input
                  ...
                  onChange={(e) => setForm(e)}
                />
                {signupFormErrors.lastNameError !== "" && (
                  <Alert severity="error">
                    {signupFormErrors.lastNameError}
                  </Alert>
                )}
                ...
                {signupFormErrors.emailError !== "" && (
                  <Alert severity="error">{signupFormErrors.emailError}</Alert>
                )}
                ...
                <input
                  ...
                  onChange={(e) => setForm(e)}
                />
                {signupFormErrors.phoneError !== "" && (
                  <Alert severity="error">{signupFormErrors.phoneError}</Alert>
                )}
              ...
              <form autoComplete="off" className="client__form form__2">
                ...
                {role === `Agency` ? (
                  <>
                    ...
                    {profileDetailsErrors.agencyNameError !== "" && (
                      <Alert severity="error">
                        {profileDetailsErrors.agencyNameError}
                      </Alert>
                    )}
                    ...
                    {profileDetailsErrors.teamStrengthError !== "" && (
                      <Alert severity="error">
                        {profileDetailsErrors.teamStrengthError}
                      </Alert>
                    )}
                    ...
                    {profileDetailsErrors.incorporationDateError !== "" && (
                      <Alert severity="error">
                        {profileDetailsErrors.incorporationDateError}
                      </Alert>
                    )}
                  ...
                  <>
                    <input
                      ...
                      onChange={(event) => handleCreateProfile(event, role)}
                    />
                    {profileDetailsErrors.userDesignationError !== "" && (
                      <Alert severity="error">
                        {profileDetailsErrors.userDesignationError}
                      </Alert>
                    )}
                    <input
                      ...
                      onChange={(event) => handleCreateProfile(event, role)}
                    />
                    {profileDetailsErrors.companyNameError !== "" && (
                      <Alert severity="error">
                        {profileDetailsErrors.companyNameError}
                      </Alert>
                    )}
                ...
                />
                {profileDetailsErrors.socialPlatformDetailsError !== "" && (
                  <Alert severity="error">
                    {profileDetailsErrors.socialPlatformDetailsError}
                  </Alert>
                )}
                ...
                <Button
                  onClick={() =>
                    handleSubmit(role, signupForm, agencyProfileDetails)
                  }
                  style={{
                    background: colors.PRIMARY_COLOR,
                    marginTop: "5vh",
