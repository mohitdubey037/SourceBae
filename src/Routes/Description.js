                        ...
                        <div className="right-content right-content-description">
                            <form className="form-description">
                                ...
                                <div className="inputArea">
                                    ...
                                    {/* <input onChange={(e) => setLocation(e.target.value)} type="text" placeholder="e.g- Indore">

                                    </input> */}
                                    <LocationSearchInput className="timezone" onChange={(e) => setLocation(e.target.value)} />
                                </div>
                                <div className="inputArea">
