...
function SkillsSet(props) {
    ...
    const [arr, setArr] = useState([
        ...
        {
            title: 'Relevant Experience In Industry',
            content: [
                {
                    points: '1yr 2months'
                }
    ...
    useEffect(() => {
        if (skillset.Industry.length > 0 && skillset.Services.length === 0)
            ...
            skillset.Services.length > 0 &&
            skillset.Technology.length === 0
        )
            getAllTechs();
                        ...
                        {modalValue?.title === 'Industry' ? (
                            props?.data?.agencyDomains.length < 2 ? (
                                ...
                                >
                                    <option>None</option>
                                    {skillset?.Industry &&
                                        skillset?.Industry.map((domain) => {
                                            return (
                                                <option
                                                    label={domain.domainName}
                                                    value={`${domain._id} ${domain.domainName}`}
                                                />
                                            );
                                        })}
                                </select>
                                    ...
                                    skillset?.Services.map((service) => {
                                        return (
                                            <option
                                                ...
                                                value={`${service._id} ${service.serviceName}`}
                                            />
                                        );
                                    })}
                            </select>
                                    ...
                                    visibleTechData.map((technology) => {
                                        return (
                                            <option
                                                ...
                                                value={`${technology._id} ${technology.technologyName}`}
                                            />
                                        );
                                    })}
                            </select>
