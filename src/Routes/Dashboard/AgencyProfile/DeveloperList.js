              ...
              return (
                <div className="developerCard">
                  <div
                    ...
                    onClick={() => deleteFunctionality(developer._id)}
                  >
                  ...
                  <div className="developerNameExp">
                    <div className="developerName">
                      <div>
                        <h2>{`${
                          developer.firstName.charAt(0).toUpperCase() +
                          developer.firstName.slice(1)
                        } ${
                          developer.lastName.charAt(0).toUpperCase() +
                          developer.lastName.slice(1)
                        }`}</h2>
                      </div>
                      <div
                        className={`rounded_developerList ${
                          toggleIndexes[index] && "conditionalColor"
                        }`}
                      ></div>
                    </div>
                  ...
                  <div className="developerBudgetResume">
                    <div className="developerBudget">
                      <div className="developer-detail">
                        ...
                        <div>
                          <p>Timeline</p>
                          <h6>
                            {developer.developerAvailability == "0"
                        ...
                        <div>
                          ...
                          <h6>{`$${developer.developerPriceRange}-$${
                            developer.developerPriceRange + 3 * 1000
                          }`}</h6>
                        </div>
                      </div>
                    </div>
                    <div className="developers_content">
                      ...
                      >
                        ...
                        <div
                          style={{
                            display: open && toggleIndexes === index && "none",
                          }}
                              ...
                              >
                                ...
                                <Grid item>
                                  <AntSwitch
                                    ...
                                    onChange={(event) =>
                                      handleChangeToggle(event, index)
                                    }
                                    name="checked"
                                  />
                                </Grid>
