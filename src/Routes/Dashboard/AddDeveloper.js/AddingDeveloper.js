            ...
            <div className="mainAddingDeveloper">
              <div className="addingDeveloperHeadings">
                ...
                <p>
                  ...
                  Porro, reiciendis natus inventore laborum distinctio numquam
                  cum pariatur voluptatum vero ipsum.
                </p>
                ...
                <img
                  src={dev}
                  alt="NotFound"
                  style={{ margin: "1rem 0rem 0rem 5rem", width: "80%" }}
                />
              </div>
                ...
                <div className="inputForm">
                            ...
                            <div {...getRootProps({ className: "dropzone" })}>
                              ...
                              <div className="file_click_addingDeveloper">
                                {acceptedFileItems.length === 0 ? (
                                  ...
                                  <div className="accepted_file_para">
                                    {acceptedFileItems}
                                  </div>
                                )}
                              </div>
                  ...
                  <div className="priceRange">
                    ...
                    {errors.developerPrice && (
                      <p className="error_paragraph">{errors.developerPrice}</p>
                    )}
                  </div>
                  <div className="availabilityArea">
                    <FormControl component="fieldset">
                      <FormLabel component="legend">
                        Availability <span className="requiredStar">*</span>
                      </FormLabel>
                      <RadioGroup
                    ...
                    {errors.developerAvailability && (
                      <p
                        style={{
                          marginTop: developerData.developerAvailability && "0",
                        }}
