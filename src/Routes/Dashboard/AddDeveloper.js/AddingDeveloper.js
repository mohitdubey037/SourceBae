...
function AddingDeveloper() {
  ...
  function getStyles(singleTechObject, allTechnologies, theme) {
    ...
    console.log(singleTechObject);
    console.log(allTechnologies);
    // console.log(theme);
    // console.log(allTechnologies.indexOf(singleTechObject));
    return {
      fontWeight:
      ...
      // color:
      //   technologyId.indexOf(technologies) === -1
  ...
  function uploadMedia() {
    ...
    resume && formData.append("files", resume, "resume");
    instance
        ...
        <div className="innerAddingDeveloper">
          <div className="addingDeveloperHeadings">
            ...
            <p>
              ...
              reiciendis natus inventore laborum distinctio numquam cum pariatur
              voluptatum vero ipsum.
            </p>
            ...
            <div className="inputField1">
              ...
              <div className="developerName">
                ...
                <FormControl className={classes.formControl}>
                  ...
                  {techs?.map((tech) => {
                    return (
                      ...
                      value={tech?._id}
                      style={getStyles(tech._id, techs, theme)}
                      /> 
                      );
                    })}
                    </Select> */}
                ...
                >
                  ...
                  {techs?.map((tech) => {
                    return (
                      <option label={tech?.technologyName} value={tech?._id} />
                    );
                  })}
                </select> */}
              </div>
            ...
            <div className="yearsOfExperience">
              <FormControl component="fieldset">
                ...
                <RadioGroup
                  ...
                  value={developerData.developerExperience}
                  onChange={(event) => handleChange(event)}
                >
                  <FormControlLabel
                    value="1"
            ...
            <div className="availabilityArea">
              <FormControl component="fieldset">
                ...
                <RadioGroup
                  ...
                  value={developerData.developerAvailability}
                  onChange={(event) => handleChange(event)}
                >
                  <FormControlLabel
                    value="0"
