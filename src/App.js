...
const App = (props) => {
  ...
  return (
    <>
      {show ? (
        <Notification title={notification.title} body={notification.body} show={show} />) : null}
      ...
      <Switch>
        ...
        <CustomRoute condition="Agency" exact path="/agencyNewestAllProject" component={AgencyNewestAllProject} />
