...
const RadioWithLabel = ({ selected, label, onClick }) => {
  return (
    <div className='flex' onClick={() => onClick(!selected)}>
      <div className='rounded-full border flex justify-center items-center border-purple-900 h-6 w-6 cursor-pointer' >
